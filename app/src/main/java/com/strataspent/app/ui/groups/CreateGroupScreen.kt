    ...
    Scaffold(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Button(onClick = vm::addInvitedEmail) {
            ...
            LazyColumn(
                ...
                items(state.invitedEmails, key = { it }) { email ->
                    AssistChip(
                        onClick = { vm.removeInvitedEmail(email) },
                        label = { Text(email) },
                        trailingIcon = {
                            Icon(
            ...
            Button(
                ...
                if (state.loading) {
                    ...
                    Text(stringResource(R.string.groups_create_action))
                }
            }
        }
    }
